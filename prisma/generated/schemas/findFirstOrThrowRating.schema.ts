...
export const RatingFindFirstOrThrowSelectSchema: z.ZodType<Prisma.RatingSelect> = z.object({
...
export const RatingFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    locationId: z.boolean().optional(),
    userId: z.boolean().optional(),
    value: z.boolean().optional(),
...
export const RatingFindFirstOrThrowSchema: z.ZodType<Prisma.RatingFindFirstOrThrowArgs> = z.object({ select: RatingFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => RatingIncludeObjectSchema.optional()), orderBy: z.union([RatingOrderByWithRelationInputObjectSchema, RatingOrderByWithRelationInputObjectSchema.array()]).optional(), where: RatingWhereInputObjectSchema.optional(), cursor: RatingWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RatingScalarFieldEnumSchema, RatingScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.RatingFindFirstOrThrowArgs>;

export const RatingFindFirstOrThrowZodSchema = z.object({ select: RatingFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => RatingIncludeObjectSchema.optional()), orderBy: z.union([RatingOrderByWithRelationInputObjectSchema, RatingOrderByWithRelationInputObjectSchema.array()]).optional(), where: RatingWhereInputObjectSchema.optional(), cursor: RatingWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RatingScalarFieldEnumSchema, RatingScalarFieldEnumSchema.array()]).optional() }).strict();