...
export const RatingPictureFindManySelectSchema: z.ZodType<Prisma.RatingPictureSelect> = z.object({
...
export const RatingPictureFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    ratingId: z.boolean().optional(),
    url: z.boolean().optional(),
    caption: z.boolean().optional(),
...
export const RatingPictureFindManySchema: z.ZodType<Prisma.RatingPictureFindManyArgs> = z.object({ select: RatingPictureFindManySelectSchema.optional(), include: z.lazy(() => RatingPictureIncludeObjectSchema.optional()), orderBy: z.union([RatingPictureOrderByWithRelationInputObjectSchema, RatingPictureOrderByWithRelationInputObjectSchema.array()]).optional(), where: RatingPictureWhereInputObjectSchema.optional(), cursor: RatingPictureWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RatingPictureScalarFieldEnumSchema, RatingPictureScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.RatingPictureFindManyArgs>;

export const RatingPictureFindManyZodSchema = z.object({ select: RatingPictureFindManySelectSchema.optional(), include: z.lazy(() => RatingPictureIncludeObjectSchema.optional()), orderBy: z.union([RatingPictureOrderByWithRelationInputObjectSchema, RatingPictureOrderByWithRelationInputObjectSchema.array()]).optional(), where: RatingPictureWhereInputObjectSchema.optional(), cursor: RatingPictureWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RatingPictureScalarFieldEnumSchema, RatingPictureScalarFieldEnumSchema.array()]).optional() }).strict();