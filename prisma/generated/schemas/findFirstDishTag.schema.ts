...
export const DishTagFindFirstSelectSchema: z.ZodType<Prisma.DishTagSelect> = z.object({
...
export const DishTagFindFirstSelectZodSchema = z.object({
    dishId: z.boolean().optional(),
    tagId: z.boolean().optional(),
    dish: z.boolean().optional(),
    tag: z.boolean().optional()
