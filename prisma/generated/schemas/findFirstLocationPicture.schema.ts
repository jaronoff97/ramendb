...
export const LocationPictureFindFirstSelectSchema: z.ZodType<Prisma.LocationPictureSelect> = z.object({
...
export const LocationPictureFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    locationId: z.boolean().optional(),
    url: z.boolean().optional(),
    caption: z.boolean().optional(),
...
export const LocationPictureFindFirstSchema: z.ZodType<Prisma.LocationPictureFindFirstArgs> = z.object({ select: LocationPictureFindFirstSelectSchema.optional(), include: z.lazy(() => LocationPictureIncludeObjectSchema.optional()), orderBy: z.union([LocationPictureOrderByWithRelationInputObjectSchema, LocationPictureOrderByWithRelationInputObjectSchema.array()]).optional(), where: LocationPictureWhereInputObjectSchema.optional(), cursor: LocationPictureWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LocationPictureScalarFieldEnumSchema, LocationPictureScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.LocationPictureFindFirstArgs>;

export const LocationPictureFindFirstZodSchema = z.object({ select: LocationPictureFindFirstSelectSchema.optional(), include: z.lazy(() => LocationPictureIncludeObjectSchema.optional()), orderBy: z.union([LocationPictureOrderByWithRelationInputObjectSchema, LocationPictureOrderByWithRelationInputObjectSchema.array()]).optional(), where: LocationPictureWhereInputObjectSchema.optional(), cursor: LocationPictureWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LocationPictureScalarFieldEnumSchema, LocationPictureScalarFieldEnumSchema.array()]).optional() }).strict();