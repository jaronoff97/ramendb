...
export const RatingFindManySelectSchema: z.ZodType<Prisma.RatingSelect> = z.object({
...
export const RatingFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    locationId: z.boolean().optional(),
    userId: z.boolean().optional(),
    value: z.boolean().optional(),
...
export const RatingFindManySchema: z.ZodType<Prisma.RatingFindManyArgs> = z.object({ select: RatingFindManySelectSchema.optional(), include: z.lazy(() => RatingIncludeObjectSchema.optional()), orderBy: z.union([RatingOrderByWithRelationInputObjectSchema, RatingOrderByWithRelationInputObjectSchema.array()]).optional(), where: RatingWhereInputObjectSchema.optional(), cursor: RatingWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RatingScalarFieldEnumSchema, RatingScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.RatingFindManyArgs>;

export const RatingFindManyZodSchema = z.object({ select: RatingFindManySelectSchema.optional(), include: z.lazy(() => RatingIncludeObjectSchema.optional()), orderBy: z.union([RatingOrderByWithRelationInputObjectSchema, RatingOrderByWithRelationInputObjectSchema.array()]).optional(), where: RatingWhereInputObjectSchema.optional(), cursor: RatingWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RatingScalarFieldEnumSchema, RatingScalarFieldEnumSchema.array()]).optional() }).strict();