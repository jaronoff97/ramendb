...
export const RatingTagFindFirstOrThrowSelectSchema: z.ZodType<Prisma.RatingTagSelect> = z.object({
...
export const RatingTagFindFirstOrThrowSelectZodSchema = z.object({
    ratingId: z.boolean().optional(),
    tagId: z.boolean().optional(),
    rating: z.boolean().optional(),
    tag: z.boolean().optional()
...
export const RatingTagFindFirstOrThrowSchema: z.ZodType<Prisma.RatingTagFindFirstOrThrowArgs> = z.object({ select: RatingTagFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => RatingTagIncludeObjectSchema.optional()), orderBy: z.union([RatingTagOrderByWithRelationInputObjectSchema, RatingTagOrderByWithRelationInputObjectSchema.array()]).optional(), where: RatingTagWhereInputObjectSchema.optional(), cursor: RatingTagWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RatingTagScalarFieldEnumSchema, RatingTagScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.RatingTagFindFirstOrThrowArgs>;

export const RatingTagFindFirstOrThrowZodSchema = z.object({ select: RatingTagFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => RatingTagIncludeObjectSchema.optional()), orderBy: z.union([RatingTagOrderByWithRelationInputObjectSchema, RatingTagOrderByWithRelationInputObjectSchema.array()]).optional(), where: RatingTagWhereInputObjectSchema.optional(), cursor: RatingTagWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RatingTagScalarFieldEnumSchema, RatingTagScalarFieldEnumSchema.array()]).optional() }).strict();