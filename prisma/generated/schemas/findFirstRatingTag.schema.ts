...
export const RatingTagFindFirstSelectSchema: z.ZodType<Prisma.RatingTagSelect> = z.object({
...
export const RatingTagFindFirstSelectZodSchema = z.object({
    ratingId: z.boolean().optional(),
    tagId: z.boolean().optional(),
    rating: z.boolean().optional(),
    tag: z.boolean().optional()
...
export const RatingTagFindFirstSchema: z.ZodType<Prisma.RatingTagFindFirstArgs> = z.object({ select: RatingTagFindFirstSelectSchema.optional(), include: z.lazy(() => RatingTagIncludeObjectSchema.optional()), orderBy: z.union([RatingTagOrderByWithRelationInputObjectSchema, RatingTagOrderByWithRelationInputObjectSchema.array()]).optional(), where: RatingTagWhereInputObjectSchema.optional(), cursor: RatingTagWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RatingTagScalarFieldEnumSchema, RatingTagScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.RatingTagFindFirstArgs>;

export const RatingTagFindFirstZodSchema = z.object({ select: RatingTagFindFirstSelectSchema.optional(), include: z.lazy(() => RatingTagIncludeObjectSchema.optional()), orderBy: z.union([RatingTagOrderByWithRelationInputObjectSchema, RatingTagOrderByWithRelationInputObjectSchema.array()]).optional(), where: RatingTagWhereInputObjectSchema.optional(), cursor: RatingTagWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([RatingTagScalarFieldEnumSchema, RatingTagScalarFieldEnumSchema.array()]).optional() }).strict();