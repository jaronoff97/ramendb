...
export const DishFindFirstOrThrowSelectSchema: z.ZodType<Prisma.DishSelect> = z.object({
...
export const DishFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    locationId: z.boolean().optional(),
    name: z.boolean().optional(),
    description: z.boolean().optional(),
...
export const DishFindFirstOrThrowSchema: z.ZodType<Prisma.DishFindFirstOrThrowArgs> = z.object({ select: DishFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => DishIncludeObjectSchema.optional()), orderBy: z.union([DishOrderByWithRelationInputObjectSchema, DishOrderByWithRelationInputObjectSchema.array()]).optional(), where: DishWhereInputObjectSchema.optional(), cursor: DishWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DishScalarFieldEnumSchema, DishScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.DishFindFirstOrThrowArgs>;

export const DishFindFirstOrThrowZodSchema = z.object({ select: DishFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => DishIncludeObjectSchema.optional()), orderBy: z.union([DishOrderByWithRelationInputObjectSchema, DishOrderByWithRelationInputObjectSchema.array()]).optional(), where: DishWhereInputObjectSchema.optional(), cursor: DishWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DishScalarFieldEnumSchema, DishScalarFieldEnumSchema.array()]).optional() }).strict();